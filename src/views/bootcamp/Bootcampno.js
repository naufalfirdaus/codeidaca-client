...
<div className='result'>
  Top Bootcamp Regular Student NodeJS
        ...
        <section
            className=" mt-0 bg-white text-center flex flex-col items-center"
            id="testimonial"
        >
          <div className='font-bold  mt-10'>Testimonial</div>
            <div
                className="mt-12 ml-6 min-w-[80vw] justify-center md:gap-4 md:min-w-full grid gap-8 md:grid-cols-5  "
                data-aos="fade-up"
