...
import { doAddApplyRequest, doAddApplySucceed} from '../../redux-saga/actions/Apply';
export default function ApplyRedux() {
    ...
    const formik = useFormik({
      ...
      onSubmit : async(values)=>{
        ...
        dispatch(doAddApplyRequest(payload))
    ...
    return (
        <div>
          ...
          <input type = 'file' className='flex items-center justify-center border w-2/6 h-32 rounded-full border-gray-500'/>
          </div> */}
