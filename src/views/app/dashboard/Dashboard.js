...
export default function Dashboard() {
  ...
  const {summary } = useSelector((state) => state.dashboardState)
            ...
            <div class="w-full lg:w-1/4">
              <div class="widget w-full p-4 rounded-lg bg-white border border-gray-100 dark:bg-gray-900 dark:border-gray-800">
                <div class="flex flex-row items-center justify-between">
                  <div class="flex flex-col">
                    <div class="text-xs uppercase font-light text-white">
                      Candidate
                    </div>
                    <div class="text-xl text-white font-bold">{data.Candidate}</div>
                  </div>
                  <svg
                    stroke="currentColor"
                    fill="none"
              ...
              <div class="widget w-full p-4 rounded-lg bg-white border border-gray-100 dark:bg-gray-900 dark:border-gray-800">
                <div class="flex flex-row items-center justify-between">
                  <div class="flex flex-col">
                    ...
                    <div class="text-xl text-white font-bold">{data.Bootcamp}</div>
                  </div>
                  <svg
                    stroke="currentColor"
                    fill="none"
              ...
              <div class="widget w-full p-4 rounded-lg bg-white border border-gray-100 dark:bg-gray-900 dark:border-gray-800">
                <div class="flex flex-row items-center justify-between">
                  <div class="flex flex-col">
                    ...
                    <div class="text-xl text-white font-bold">{data.Placement}</div>
                  </div>
                  <svg
                    stroke="currentColor"
                    fill="none"
              ...
              <div class="widget w-full p-4 rounded-lg bg-white border border-gray-100 dark:bg-gray-900 dark:border-gray-800">
                <div class="flex flex-row items-center justify-between">
                  <div class="flex flex-col">
                    ...
                    <div class="text-xl text-white font-bold">{data.Idle}</div>
                  </div>
                  <svg
                    stroke="currentColor"
                    fill="none"
                ...
                <div class="flex flex-row w-full">
                  <div class="h-60">
                    <div class="recharts-responsive-container w-96 object-center">
                        <div class="object-center text-white px-14 ">
                        <ApplicantChart />
                        </div>
